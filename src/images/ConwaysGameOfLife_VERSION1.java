 ...
 */
public class ConwaysGameOfLife_VERSION1 extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        ...
        JFrame game = new ConwaysGameOfLife_VERSION1();
        game.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        game.setTitle("Conway's Game of Life");
        game.setIconImage(new ImageIcon(ConwaysGameOfLife_VERSION1.class.getResource("/images/logo.png")).getImage());
    ...
    public ConwaysGameOfLife_VERSION1() {
        // Setup menu
